...
const stats = [
  { value: "8 900+", label: "Donneurs actifs" },
  { value: "42", label: "Hôpitaux partenaires" },
  { value: "1 240", label: "Dons ce mois" },
];
...
const features = [
  {
    ...
    desc: "Recevez instantanément les demandes urgentes des hôpitaux proches de chez vous.",
  },
  {
    icon: Heart,
    color: "bg-[#F0FFF4]",
    ...
    desc: "Suivez l'impact de chaque don et visualisez les vies que vous avez contribué à sauver.",
  },
  {
    icon: Shield,
    color: "bg-[#FFF8F0]",
    ...
    desc: "Tous nos hôpitaux partenaires sont vérifiés et agréés par les autorités sanitaires.",
  },
];
    ...
    <PublicLayout>
      ...
      <section className="relative flex flex-col items-center justify-center min-h-[calc(100vh-64px)] px-6 py-16 text-center overflow-hidden">
        ...
        >
          ...
          >
            ...
            >
              {isFrench ? "Réseau de don de sang · Burkina Faso" : "Blood donation network · Burkina Faso"}
            </span>
          </motion.div>
          ...
          >
            <Link to="/register">
              <Button size="lg" className="w-full sm:w-auto min-w-[200px] text-[16px]">
                {isFrench ? "Devenir donneur" : "Become a donor"}
          ...
          >
            {isFrench
              ? "✓ Gratuit · ✓ Sécurisé · ✓ Un geste qui sauve"
              : "✓ Free · ✓ Secure · ✓ A gesture that saves lives"}
          </motion.p>
        </motion.div>
        ...
        <div className="max-w-[1000px] mx-auto">
          ...
          >
            <Typography.H2 className="text-[28px] md:text-[36px] mb-3">
              {isFrench ? "Pourquoi rejoindre SangVie ?" : "Why join SangVie?"}
            </Typography.H2>
            <Typography.Body className="max-w-[480px] mx-auto text-[15px]">
              {isFrench
                ? "Une plateforme conçue pour connecter rapidement les donneurs aux hôpitaux qui en ont besoin."
                : "A platform designed to quickly connect donors to hospitals in need."}
            </Typography.Body>
          </motion.div>
      ...
      <section className="bg-[#CC0000] py-16 px-6 text-center">
        ...
        >
          ...
          >
            {isFrench
              ? "Chaque don compte. Commencez aujourd'hui."
              : "Every donation counts. Start today."}
          </h2>
          <p
          ...
          >
            {isFrench
              ? "Rejoignez des milliers de donneurs qui sauvent des vies partout au Burkina Faso."
              : "Join thousands of donors saving lives across Burkina Faso."}
          </p>
          <Link to="/register">
            <button
