      ...
      <div className="max-w-xl mx-auto pb-10">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1.5">
                  <div className="flex items-center gap-1 bg-[#F0FFF4] border border-[#1A7A3F]/20 rounded-full px-2.5 py-0.5">
                    ...
                    <span className="text-[11px] font-bold text-[#1A7A3F]" style={{ fontFamily: "'DM Sans', sans-serif" }}>Vérifié</span>
                  </div>
            ...
            <div className="grid grid-cols-2 gap-3 mt-5">
              <div className="bg-[#F7F7F8] rounded-xl p-3 flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#AAAAAA] font-medium" style={{ fontFamily: "'DM Sans', sans-serif" }}>Demandes totales</p>
                </div>
              </div>
              <div className="bg-[#F7F7F8] rounded-xl p-3 flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-[#AAAAAA] font-medium" style={{ fontFamily: "'DM Sans', sans-serif" }}>Dons confirmés</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-[#EBEBEB] mb-4 overflow-hidden shadow-[0_1px_8px_rgba(0,0,0,0.05)]">
          <div className="flex items-center justify-between px-5 py-4 border-b border-[#F5F5F5]">
            ...
            >
              {isEditing ? <><X className="w-3.5 h-3.5" /> Annuler</> : <><Pencil className="w-3.5 h-3.5" /> Modifier</>}
            </button>
          </div>
          <div className="px-5">
            <Field icon={Building2} label="Nom de l'hôpital" field="nom" value={formData.nom} />
            <Field icon={Mail} label="Email institutionnel" value={user?.email || ""} editable={false} />
            <Field icon={Phone} label="Téléphone" field="contact" value={formData.contact} type="tel" />
            <Field icon={MapPin} label="Région" field="region" value={formData.region} />
            <Field icon={MapPin} label="Localisation précise" field="localisation" value={formData.localisation} />
            <Field icon={ShieldCheck} label="Numéro d'Agrément" value={user?.numeroAgrement || ""} editable={false} />
          </div>
          <AnimatePresence>
            {isEditing && (
              <motion.div
        ...
        <div className="bg-white rounded-2xl border border-[#EBEBEB] mb-4 overflow-hidden shadow-[0_1px_8px_rgba(0,0,0,0.05)]">
          <div className="px-5 py-4 border-b border-[#F5F5F5]">
            <h2 className="text-[15px] font-bold text-[#0A0A0A]" style={{ fontFamily: "'DM Sans', sans-serif" }}>Paramètres</h2>
          </div>
          <div className="px-5 py-4 flex items-center justify-between border-b border-[#F5F5F5]">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[14px] font-semibold text-[#111111]" style={{ fontFamily: "'DM Sans', sans-serif" }}>Notifications</p>
                <p className="text-[11px] text-[#AAAAAA]" style={{ fontFamily: "'DM Sans', sans-serif" }}>Alertes de demandes urgentes</p>
              </div>
            </div>
            <button
          ...
          <button className="w-full px-5 py-4 flex items-center gap-3 hover:bg-[#FAFAFA] transition-colors">
            <div className="p-2 rounded-xl bg-[#F5F5F5]">
              <Globe className="w-4 h-4 text-[#888888]" />
            </div>
            <div className="flex-1 text-left">
              <p className="text-[14px] font-semibold text-[#111111]" style={{ fontFamily: "'DM Sans', sans-serif" }}>Langue</p>
              <p className="text-[11px] text-[#AAAAAA]" style={{ fontFamily: "'DM Sans', sans-serif" }}>Français</p>
            </div>
