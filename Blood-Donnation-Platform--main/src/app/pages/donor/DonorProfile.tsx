    ...
    <DonorLayout>
      <div className="p-4 md:p-6 max-w-xl mx-auto pb-28 md:pb-8">
        ...
        <div className="bg-white rounded-2xl border border-[#EBEBEB] mb-4 overflow-hidden shadow-[0_1px_8px_rgba(0,0,0,0.05)]">
          ...
          <div className="px-5">
            <ProfileField icon={UserIcon} label="Prénom" field="prenom" value={formData.prenom} />
            <ProfileField icon={UserIcon} label="Nom de famille" field="nom" value={formData.nom} />
            <ProfileField icon={Phone} label="Téléphone" field="telephone" value={formData.telephone} />
            <ProfileField icon={MapPin} label="Lieu de résidence" field="lieuResidence" value={formData.lieuResidence} />
            <ProfileField icon={Droplet} label="Groupe Sanguin" value={user?.groupeSanguin || ""} editable={false} />
            <ProfileField icon={Calendar} label="Date d'inscription" value={user?.createdAt ? new Date(user.createdAt).toLocaleDateString() : "N/A"} editable={false} />
          </div>
